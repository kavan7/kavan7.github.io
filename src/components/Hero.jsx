...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-[480px] sm:h-[650px] ">
      ...
      sm:mt-16 mt-6 ml-0 `}>I'm a Grade 12 student <br className="sm:block hidden " />with a keen interest in developing web applications, <br className="sm:block hidden" />integrating with machine learning and more.<br  /></p>
